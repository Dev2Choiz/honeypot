...
<h3>";
        // line 22
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form_filtre"), "nom", array()), 'label', array("label" => "Filtre par marques"));
        echo "</h3>
";
        // line 23
